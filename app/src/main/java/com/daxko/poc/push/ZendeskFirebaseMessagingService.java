...
public class ZendeskFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private Intent getDeepLinkIntent(String requestId) {
        ...
        final Intent mainActivity = new Intent(getApplicationContext(), ChallengeListActivity.class);
        mainActivity.putExtra(ChallengeListActivity.EXTRA_VIEWPAGER_POSITION, ChallengeListActivity.POS_HELP);
