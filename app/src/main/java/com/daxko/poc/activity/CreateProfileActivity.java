...
import com.daxko.poc.utility.ImageUtils;
...
import static com.daxko.poc.MyApplication.getStorage;
    ...
    private void showStoredProfile() {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Belvedere.from(CreateProfileActivity.this.getApplicationContext())
                        .document()
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (isProfileSettable) {
            ...
            Toast.makeText(getApplicationContext(),
                    getResources().getString(R.string.profile_invalid_email),
                    Toast.LENGTH_LONG)
                    .show();
        }
